...
namespace PoE2BuildCalculator
{
    public partial class Compute : Form
    {
        ...
        private readonly DataGridViewCellStyle _defaultCellStyle = new() { Format = "0.00", Alignment = DataGridViewContentAlignment.MiddleCenter, DataSourceNullValue = 0.0d, NullValue = 0.0d };
        ...
        private void InitializeCustomComponents()
        {
            ...
            //TableTiers.Dock = DockStyle.Fill;
            ...
            var nameColumn = new DataGridViewTextBoxColumn
            {
                ...
                DefaultCellStyle = new DataGridViewCellStyle { Alignment = DataGridViewContentAlignment.MiddleCenter, DataSourceNullValue = string.Empty, NullValue = string.Empty },
        ...
        private void AddTierButton_Click(object sender, EventArgs e)
        {
            ...
            object[] rowValues = new object[3 + newTier.StatWeights.Keys.Count];
            ...
            newRow.CreateCells(TableTiers, rowValues); //map columns and initial values according to the grid
            TableTiers.Rows.Add(newRow);
