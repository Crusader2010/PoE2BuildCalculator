...
namespace PoE2BuildCalculator
{
    ...
    {
        public ImmutableList<Item> _itemsToDisplay { get; private set; } = [];
        ...
        public DataDisplay(ImmutableList<Item> itemsToDisplay)
        {
            ...
            if (itemsToDisplay != null && itemsToDisplay.Count > 0) _itemsToDisplay = itemsToDisplay;
        }
        ...
        private void ImportDataToDisplay_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (var item in _itemsToDisplay) // Populate rows using PropertyDescriptionHelper.ToDictionary for each item.
                {
